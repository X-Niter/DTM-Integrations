...
@Mixin(value = GoldenrodWorldGenerator.class, remap = false)
public class MixinGoldenrodWorldGenerator {
    ...
    private void generateOverworld(World world, Random rand, int blockX, int blockZ) {
        ...
        for(int i = 0; i < num; ++i) {
            ...
            this.generator.generate(world, rand, new BlockPos(randX, rand.nextInt(128), randZ));
        }
    }
}
